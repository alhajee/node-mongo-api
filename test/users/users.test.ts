...
let firstUserIdTest = "";
const firstUserBody = {
  email: `admin${shortid.generate()}@test.com`,
  password: "Sup3rSecret!23",
};

let accessToken = "";
let refreshToken = "";
const newFirstName = "Abdul";
const newFirstName2 = "Aburo";
const newLastName2 = "Lomo";
...
describe("users and auth endpoints", function () {
  ...
  it("should allow a POST to /users (CREATE USER)", async function () {
  ...
  it("should allow a POST to /auth (LOGIN)", async function () {
